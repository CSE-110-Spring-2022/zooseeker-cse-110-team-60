...
public class RoutePlanSummaryTest {
    ...
    public void routePlanSummaryTest() {
        ...
        onView(allOf(withId(R.id.main_clearButton), withText("Clear"),
                        childAtPosition(
                                childAtPosition(
        ...
        onView(allOf(withId(R.id.main_directionsButton), withText("Get Directions"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        onView(allOf(withId(R.id.summary_item_text), withText("Gate to Alligators (110.0 meters)"),
                        withParent(withParent(withId(R.id.direction_item_text))),
        ...
        onView(
                allOf(withId(R.id.direction_header), withText("Entrance and Exit Gate to Alligators (110.0m)"),
                        withParent(withParent(withId(android.R.id.content))),
