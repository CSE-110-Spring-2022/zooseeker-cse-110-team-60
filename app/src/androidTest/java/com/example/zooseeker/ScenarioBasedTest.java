...
public class ScenarioBasedTest {
    ...
    public void scenarioBasedTest() {
        ...
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.showCheckedBtn), withText("Show"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction materialButton5 = onView(
                allOf(withId(R.id.direction_toggle_button), withText("Detailed"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction materialButton6 = onView(
                allOf(withId(R.id.direction_toggle_button), withText("BRIEF"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction materialButton9 = onView(
                allOf(withId(R.id.direction_skip_button), withText("Skip"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
