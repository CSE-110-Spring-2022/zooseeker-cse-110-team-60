...
public class ZooData {
    ...
    public static Map<String, VertexInfo> loadVertexInfoJSON(Context context,
                                                                     String path) {
        try {
    ...
    public static Map<String, EdgeInfo> loadEdgeInfoJSON(Context context,
                                                                 String path) {
        try {
            InputStream inputStream = context.getAssets().open(path);
            Reader reader = new InputStreamReader(inputStream);
            ...
            Map<String, EdgeInfo> indexedZooData = zooData.stream()
                                                                  .collect(Collectors.toMap(v -> v.id, datum -> datum));
