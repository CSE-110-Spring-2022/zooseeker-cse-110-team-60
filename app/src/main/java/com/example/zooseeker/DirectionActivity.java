...
//    private GPSTracker gpsTracker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.direction_directionsRecyclerView);
...
//        body = findViewById(R.id.direction_body_textView);
        ...
        skipButton = findViewById(R.id.direction_skipButton);
        toggleButton = findViewById(R.id.direction_toggleButton);
        mockLocation = findViewById(R.id.direction_linearLayout_mockLocation);
        mockButton = findViewById(R.id.direction_mockButton);
        mockLatitude = findViewById(R.id.direction_mockLatitude);
        mockLongitude = findViewById(R.id.direction_mockLongitude);
        enterMockLocation = findViewById(R.id.direction_mockLocation);
